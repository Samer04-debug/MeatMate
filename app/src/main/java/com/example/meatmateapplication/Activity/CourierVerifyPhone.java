...
public class CourierVerifyPhone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_courier_verify_phone);
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks mcallBack=new PhoneAuthProvider.OnVerificationStateChangedCallbacks(){
        ...
        public void onVerificationFailed(@NonNull FirebaseException e) {
            Toast.makeText(CourierVerifyPhone.this , e.getMessage(),Toast.LENGTH_LONG).show();
    ...
    private void linkCredential(PhoneAuthCredential credential) {
        ...
        FAuth.getCurrentUser().linkWithCredential(credential)
                .addOnCompleteListener(CourierVerifyPhone.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {

                        if(task.isSuccessful()){

                            Intent intent = new Intent(CourierVerifyPhone.this , MainMenu.class);
                            startActivity(intent);
                            finish();
                        }else{
                            ReusableCodeForAll.ShowAlert(CourierVerifyPhone.this,"Error",task.getException().getMessage());
                        }
                    }
                });
