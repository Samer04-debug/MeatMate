...
public class CourierLoginphone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_courier_loginphone);
        ...
        sendotp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent b = new Intent(CourierLoginphone.this,Couriersendotp.class);
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(CourierLoginphone.this,CourierSignup.class));
                finish();
            }
        });
        signinemail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(CourierLoginphone.this,CourierLogin.class));
                finish();
            }
        });
