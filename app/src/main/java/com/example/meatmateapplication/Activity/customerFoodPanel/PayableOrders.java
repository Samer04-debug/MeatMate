...
public class PayableOrders extends AppCompatActivity {
    ...
    private PayableOrdersAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        grandtotal = findViewById(R.id.php);
        ...
        adapter = new PayableOrdersAdapter(PayableOrders.this, customerPaymentOrdersList);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    for (final DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        ...
                        DatabaseReference data = FirebaseDatabase.getInstance().getReference("CustomerPaymentOrders").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(snapshot.getKey()).child("Meats");
