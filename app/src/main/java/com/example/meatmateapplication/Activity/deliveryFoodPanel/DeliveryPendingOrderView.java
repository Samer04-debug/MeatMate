...
public class DeliveryPendingOrderView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerViewmeat = findViewById(R.id.delivieworder);
        recyclerViewmeat.setHasFixedSize(true);
        recyclerViewmeat.setLayoutManager(new LinearLayoutManager(DeliveryPendingOrderView.this));
    ...
    private void deliveryorders() {
        ...
        reference = FirebaseDatabase.getInstance().getReference("DeliveryShipOrders").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(RandomUID).child("Meats");
