...
public class CourierSignup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mobileno = (TextInputLayout)findViewById(R.id.mobiled);
        localaddress = (TextInputLayout)findViewById(R.id.DLocaladdressAdmin);
        pincode = (TextInputLayout)findViewById(R.id.Pincodee);
        Cityspin = findViewById(R.id.CityspinD);
        Barangayspin = findViewById(R.id.BarangayspinD);
        ...
        Cityspin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (barangayArrayId != 0) {
                    ArrayAdapter<CharSequence> barangayAdapter = ArrayAdapter.createFromResource(CourierSignup.this,
        ...
        databaseReference = firebaseDatabase.getInstance().getReference("Courier");
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isValid()){
                    final ProgressDialog mDialog = new ProgressDialog(CourierSignup.this);
                    ...
                    FAuth.createUserWithEmailAndPassword(emailid,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()){
                                ...
                                databaseReference = FirebaseDatabase.getInstance().getReference("Courier").child(useridd);
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        ...
                                                        FAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                            ...
                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                ...
                                                                if(task.isSuccessful()){
                                                                    AlertDialog.Builder builder = new AlertDialog.Builder(CourierSignup.this);
                                                                    ...
                                                                    builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                                                        ...
                                                                        public void onClick(DialogInterface dialog, int which) {
                                                                            ...
                                                                            Intent b = new Intent(CourierSignup.this,CourierVerifyPhone.class);
                                                                    ...
                                                                    mDialog.dismiss();
                                                                    ReusableCodeForAll.ShowAlert(CourierSignup.this,"Error",task.getException().getMessage());
                                                                }
                                                            }
                                                        });
        ...
        Emaill.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(CourierSignup.this,CourierLogin.class));
                finish();
            }
        });
        Phone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(CourierSignup.this,CourierLoginphone.class));
                finish();
            }
        });
    }
