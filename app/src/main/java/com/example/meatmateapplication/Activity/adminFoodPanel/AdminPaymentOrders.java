...
public class AdminPaymentOrders {
    ...
    public AdminPaymentOrders(String adminId, String meatId, String meatName, String meatPrice, String meatQuantity, String randomUID, String totalPrice, String userId) {
        AdminId = adminId;
        MeatId = meatId;
        MeatName = meatName;
        MeatPrice = meatPrice;
