...
public class DeliveryShipOrders1 {
    ...
    public DeliveryShipOrders1(String address, String adminId, String adminName, String grandTotalPrice, String mobileNumber, String name, String randomUID, String status, String userId) {
        Address = address;
        AdminId = adminId;
        AdminName = adminName;
