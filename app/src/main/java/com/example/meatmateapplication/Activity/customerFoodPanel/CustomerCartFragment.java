...
public class CustomerCartFragment extends Fragment {
    ...
    String MeatId, RandomUId, AdminId;
                ...
                if (cartModelList.size() == 0) {
                    ...
                    remove.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setMessage("Are you sure you want to remove Meat?");
                                                ...
                                                group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
                                                    ...
                                                    public void onCheckedChanged(RadioGroup group, int checkedId) {
                                                        if (home.isChecked()) {
                                                            ...
                                                            localaddress.setText(customer.getLocalAddress() + ", " + customer.getCity());
                                                        ...
                                                        reference.addListenerForSingleValueEvent(new ValueEventListener() {
                                                            ...
                                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                ...
                                                                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                                                                    ...
                                                                    hashMap.put("MeatID", cart1.getMeatID());
                                                                    hashMap.put("MeatName", cart1.getMeatName());
                                                                    hashMap.put("MeatQuantity", cart1.getMeatQuantity());
                                                                    hashMap.put("Price", cart1.getPrice());
                                                                    hashMap.put("TotalPrice", cart1.getTotalprice());
                                                                    FirebaseDatabase.getInstance().getReference("CustomerPendingOrders").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(RandomUId).child("Meats").child(MeatId).setValue(hashMap);
                                                                                    ...
                                                                                    public void onComplete(@NonNull Task<Void> task) {
                                                                                        FirebaseDatabase.getInstance().getReference("Cart").child("GrandTotal").child(FirebaseAuth.getInstance().getUid()).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                            ...
                                                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                                                ...
                                                                                                getRef = FirebaseDatabase.getInstance().getReference("CustomerPendingOrders").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(RandomUId).child("Meats");
                                                                                                getRef.addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                                    ...
                                                                                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                                        ...
                                                                                                        for (DataSnapshot dataSnapshot2 : dataSnapshot.getChildren()) {
                                                                                                            ...
                                                                                                            String d = customerPendingOrders.getMeatID();
                                                                                                            String userid = FirebaseAuth.getInstance().getCurrentUser().getUid();
                                                                                                            AdminId = customerPendingOrders.getAdminId();
                                                                                                            final HashMap<String, String> hashMap2 = new HashMap<>();
                                                                                                            hashMap2.put("AdminId", AdminId);
                                                                                                            hashMap2.put("MeatId", customerPendingOrders.getMeatID());
                                                                                                            hashMap2.put("MeatName", customerPendingOrders.getMeatName());
                                                                                                            hashMap2.put("MeatQuantity", customerPendingOrders.getMeatQuantity());
                                                                                                            ...
                                                                                                            FirebaseDatabase.getInstance().getReference("AdminPendingOrders")
                                                                                                                    .child(AdminId)
                                                                                                                    .child(RandomUId)
                                                                                                                    .child("Meats")
                                                                                                                    .child(d)
                                                                                                        ...
                                                                                                        dataa = FirebaseDatabase.getInstance().getReference("CustomerPendingOrders")
