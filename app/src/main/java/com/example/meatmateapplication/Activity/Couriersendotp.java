...
public class Couriersendotp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_couriersendotp);
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks mcallBack=new PhoneAuthProvider.OnVerificationStateChangedCallbacks(){
        ...
        public void onVerificationFailed(@NonNull FirebaseException e) {
            Toast.makeText(Couriersendotp.this , e.getMessage(),Toast.LENGTH_LONG).show();
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()){
                            startActivity(new Intent(Couriersendotp.this,DeliveryFoodPanel_BottomNavigation.class));
                            finish();

                        }else{
                            ReusableCodeForAll.ShowAlert(Couriersendotp.this,"Error",task.getException().getMessage());
                        }
