...
public class PendingOrdersAdapter extends RecyclerView.Adapter<PendingOrdersAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.pending_orders_meat, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.Meatname.setText(customerPendingOrders.getMeatName());
        holder.Price.setText("Price: ₱ " + customerPendingOrders.getPrice());
        holder.Quantity.setText("× " + customerPendingOrders.getMeatQuantity());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            Meatname = itemView.findViewById(R.id.meatss);
