...
public class DeliveryShipOrderViewAdapter extends RecyclerView.Adapter<DeliveryShipOrderViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.meatname.setText(deliveryShipFinalOrders.getMeatName());
        holder.price.setText("Price: ₱ " + deliveryShipFinalOrders.getMeatPrice());
        holder.quantity.setText("× " + deliveryShipFinalOrders.getMeatQuantity());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            meatname = itemView.findViewById(R.id.meat2);
