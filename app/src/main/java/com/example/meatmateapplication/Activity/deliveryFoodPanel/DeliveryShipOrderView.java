...
public class DeliveryShipOrderView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerViewmeat = findViewById(R.id.delishipvieworder);
        recyclerViewmeat.setHasFixedSize(true);
        recyclerViewmeat.setLayoutManager(new LinearLayoutManager(DeliveryShipOrderView.this));
    ...
    private void deliveryfinalorders() {
        ...
        reference = FirebaseDatabase.getInstance().getReference("DeliveryShipFinalOrders").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(RandomUID).child("Meats");
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                number.setText("+63" + deliveryShipFinalOrders1.getMobileNumber());
